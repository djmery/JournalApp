...
describe('Pruebas en AuthThunks', () => {
    ...
    test('debe de invocar el checking credentials', async () => {
        ...
        // console.log(valor);
        //el primer() es el llamado de la función, el segundo () el valor de retorno de la función
    ...
    test('startCreatingUserWithEmailPassword debe de llamar checkingCredentials y login - Exito', async () => {
        const loginData = { ok: true, ...demoUser };
        const formData = { email: demoUser.email, password: '123456', name: demoUser.displayName };
    ...
    test('startLoginWithEmailPassword debe de llamar CheckingCredentials y login - Error', async () => {
        const loginData = { ok: false, errorMessage: 'Error credenciales' };
        const formData = { email: demoUser.email, password: '123456' };
        await loginWithEmailPassword.mockResolvedValue(loginData);
